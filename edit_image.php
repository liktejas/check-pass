...
<?php include 'above_sidebar.php'?>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      ...
      <?php
        if(isset($_POST['update_image']))
        {
            ...
            $old_image_sql = "SELECT img FROM users WHERE id=$id";
            ...
            $update_user_details_sql = "UPDATE `users` SET `img` = '$fileName', `updated_at`='$updated_at' WHERE `id` = $id";
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Edit User Image</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <div class="content">
      <div class="container-fluid">
        <form action="<?php $base_url?>edit_image.php?id=<?php echo $id?>" method="post" enctype="multipart/form-data">
          <div class="row">
            <div class="col-md-6">
