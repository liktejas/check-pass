    ...
    <div class="content-header">
      ...
      <?php
        if(isset($_POST['submit_changes']))
        {
            ...
            $update_admin_details_sql = "UPDATE `admin` SET `name` = '$name', `contact` = '$contact', `email` = '$email', `updated_at` = '$updated_at' WHERE `id` = $id";
            $update_admin_details = mysqli_query($connection, $update_admin_details_sql);
            if($update_admin_details == 1)
            {
       ?>
