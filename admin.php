...
<html lang="en">
  <head>
    ...
    <title>Admin Login | Check Pass</title>
    <style>
  ...
  <body>
		...
		if(isset($_POST['login']))
		{
			...
			{
                $base_url;
				$get_admin_details = mysqli_fetch_array($q);
                $get_admin_id = $get_admin_details['id'];
                $get_admin_name = $get_admin_details['name'];
                $get_admin_img = $get_admin_details['img'];
				$_SESSION['admin_id'] = $get_admin_id;
				$_SESSION['admin_username'] = $username;
				$_SESSION['admin_name'] = $get_admin_name;
				$_SESSION['admin_img'] = $get_admin_img;
	    ...
	    ?>
            <div class="text-center">
                ...
                <img src="assets/dist/img/id-card128.png" alt="" width="80" class="mb-3">&emsp;<h1 class="mt-4">CHECK PASS</h1>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                <h1 class="text-center" style="background-color:black;color:white">Admin Login</h1>
